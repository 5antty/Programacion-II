...
Function busquedaAcotada(a: arbol; inf, sup:LongInt): Integer;
...
Begin
  ...
  While (l<>Nil) Do
    ...
    End;
  imprimirpornivel(a);
  writeln('La cantidad de jugadores entre 30.000.000 y 40.000.000 es: ',
          busquedaAcotada(a, 30000000, 40000000));
